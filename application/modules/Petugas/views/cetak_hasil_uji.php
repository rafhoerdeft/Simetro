            ...
            <div class="row page-titles">
                ...
                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url().'Petugas/hasilPengujian' ?>" class="text-danger">Hasil Pengujian</a></li>
                                ...
                                <tr>
                                    <td>
                                        <div class="row">
                                           ...
                                           <div class="col-md-6 text-center" style="line-height: 20px;">
                                               ...
                                               <br> <br> <br> <br> <br>
                                               <div style="font-weight: bold; text-transform: capitalize;" id="ttd_nama"><u>Drs. ASFURI, M.Si</u></div>
        ...
        <script type="text/javascript">
            ...
            function cetakHasil(data) {
                ...
                $.post("<?= base_url().'Petugas/getDataHasilUji' ?>", {id_list:id_list, id_uttp:id_uttp}, function(result){
                    ...
                    if (dt.response) {
                        ...
                        $('#modal-cetak #tgl_tera').html(addZero(tgl_tera.getDate())+' '+nama_bulan(tgl_tera.getMonth()+1)+' '+tgl_tera.getFullYear());
                        $('#modal-cetak #petugas').html(dt.data.nama_petugas+' / NIP. '+dt.data.nip);
                        $('#modal-cetak #hasil').html(dt.data.hasil_tera);
                        $('#modal-cetak #berlaku').html(addZero(tgl_berlaku.getDate())+' '+nama_bulan(tgl_berlaku.getMonth()+1)+' '+tgl_berlaku.getFullYear());
            ...
            function printForm(argument) {
                    ...
                    window.location.href = "<?=base_url().'Petugas/cetakHasilPengujian/'.encode($id_daftar) ?>";
