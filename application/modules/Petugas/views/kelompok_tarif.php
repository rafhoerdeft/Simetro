            ...
            <div id="modal-add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="addKelompokTarif" method="POST" action="<?= base_url().'Petugas/addKelompokTarif' ?>">
            ...
            <div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateKelompokTarif" method="POST" action="<?= base_url().'Petugas/updateKelompokTarif' ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function addGroup(id) {
                ...
                $.post("<?= base_url().'Petugas/getDataKelompok' ?>", {id_kategori_alat:id}, function(result){
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo base_url('Petugas/deleteKelompokTarif')?>",
                        dataType : "html",
                        data : {id:id},
