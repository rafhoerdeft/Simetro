        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-6 align-self-center">
                    <h3 class="text-themecolor">Kategori Alat Ukur</h3>
                </div>

                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                        <!-- <label>Jenis Perlengkapan</label> -->
                        <li class="breadcrumb-item active">Kategori Alat Ukur</li>
                    </ol>
                </div>
                                            ...
                                            <tr style="font-size: 12pt">
                                                ...
                                                <td width="130" align="center">
                                                    <div class="d-none d-sm-none d-md-block d-lg-block">
                                                        <button type="button" data-id="<?= $ktg->id_kategori_alat ?>" data-nama="<?= $ktg->nama_kategori_alat ?>" onclick="editData(this)" class="btn btn-sm btn-info waves-effect waves-light m-b-5" style="width: 35px" title="Edit Kelompok"><i class="fa fa-edit"></i></button>
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="javascript:void(0)" data-id="<?= $ktg->id_kategori_alat ?>" data-nama="<?= $ktg->nama_kategori_alat ?>" onclick="editData(this)"><i class="fa fa-pencil-square-o"></i> Edit Kelompok Tarif</a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Tambah Kategori Alat</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <form id="inputKategoriAlat" method="POST" action="<?= base_url().'Petugas/inputKategoriAlat' ?>">
                            <div class="modal-body">

                                <!-- <input type="hidden" name="id_kategori_alat" id="id_kategori_alat"> -->

                                <div class="form-group">
                                    <label for="nama_kategori_alat" class="control-label">Nama Kategori Alat:</label>
                                    <input type="text" class="form-control" id="nama_kategori_alat" placeholder="Masukkan nama kategori alat" name="nama_kategori_alat" required autocomplete="off">
                                </div>
            ...
            <div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Update Kategori Alat</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <form id="updateKategoriAlat" method="POST" action="<?= base_url().'Petugas/updateKategoriAlat' ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function tambahData() {
                $('#modal-tambah #inputKategoriAlat').trigger("reset");
            ...
            function editData(data) {
                ...
                $('#modal-edit #id_kategori_alat').val(id);
                $('#modal-edit #nama_kategori_alat').val(nama);
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo base_url('Petugas/deleteKategoriAlat')?>",
                        dataType : "html",
                        data : {id:id},
