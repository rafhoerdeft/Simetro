                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr style="font-size: 11pt">
                                                <td align="center" width="20"><?= $numbers + $no ?></td>
                                                <td><?= $psr->nama_user ?></td>
            ...
            <div id="modal-tambah" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="inputKelompokPasar" method="POST" action="<?= base_url().'Petugas/inputKelompokPasar' ?>">
            ...
            <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateKelompokPasar" method="POST" action="<?= base_url().'Petugas/updateKelompokPasar/'.$this->uri->segment(3) ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo base_url('Petugas/deleteKelompokPasar')?>",
                        dataType : "html",
                        data : {id:id},
