            ...
            <div class="row page-titles">
                ...
                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url().'Petugas/'.$source ?>" class="text-danger"><?= ($source == 'pengajuanMasuk'?'Pengajuan Masuk':'Data Tera') ?></a></li>
            ...
            <div id="modal-selesai" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="simpanHasilUji" method="POST" action="<?= base_url().'Petugas/simpanHasilUji/'.$source ?>">
            ...
            <div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="updateHasilUji" method="POST" action="<?= base_url().'Petugas/updateHasilUji/'.$source ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function inputHasil(data) {
                ...
                $.post("<?= base_url().'Petugas/getDataAlat' ?>", {id_uttp:id_uttp}, function(result){
        ...
        <script type="text/javascript">
            ...
            function updateHasil(data) {
                ...
                $.post("<?= base_url().'Petugas/getDataTeraAlat' ?>", {id_uttp:id_uttp, id_list: id_list}, function(result){
                    $("#loading-show").fadeIn("slow").delay(20).slideUp('slow');
                    ...
                    if (dt.response) {
                        ...
                        $('#modal-edit #updateHasilUji #id_petugas').val(dt.dataTera.id_petugas);
            ...
            function selesaiPengajuan(id_daftar) {
                ...
                if (jml_list != jml_input) {
                    ...
                    swal({
                        ...
                        window.location.href = "<?=base_url().'Petugas/selesaiPengajuan/'.$source.'/' ?>"+id_daftar;
                    });
                }
            }
        </script>
