        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-6 align-self-center">
                    <h3 class="text-themecolor">Data Tera</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body p-b-20">
                        <!-- <a href="<?//= base_url().'Petugas/pendaftaranTera' ?>" class="btn waves-effect waves-light btn-inverse float-right"><i class="mdi mdi-file-document"></i> Pengajuan Tera</a>
                        <br><br>
                        <hr> -->
                                            ...
                                            <tr style="font-size: 10pt">
                                                ...
                                                <td width="110">
                                                    ...
                                                    <?php if ($tera->status == 'diterima') { ?>
                                                        <a href="<?= base_url().'Petugas/editPendaftaranTera/'.encode($tera->id_daftar) ?>" data-id="<?= $tera->id_daftar ?>" class="btn btn-sm btn-info waves-effect waves-light m-b-5" style="width: 35px" title="Edit Data"><i class="fa fa-pencil-square-o"></i></a>
                                                    <?php } else { ?>
                                                    ...
                                                    <button <?= ($tera->status != 'diterima'?'disabled':'') ?> type="button" onclick="showConfirmMessage('<?= $tera->id_daftar ?>')" class="btn btn-sm <?= ($tera->status == 'diterima'?'btn-danger waves-effect waves-light':'btn-default') ?> m-b-5" style="width: 35px" title="Hapus Data"><i class="fa fa-trash-o"></i></button>
            ...
            <div id="modal-kirim" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="kirimPengajuan" method="POST" action="<?= base_url().'Petugas/kirimPengajuan' ?>" enctype="multipart/form-data">
            ...
            <div id="modal-input-tgl" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="inputTglInspeksi" method="POST" action="<?= base_url().'Petugas/inputTglInspeksiTera' ?>" enctype="multipart/form-data">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            ...
            function printForm(argument) {
                    ...
                    window.location.href = "<?=base_url().'Petugas/dataTera' ?>";
            }
        </script>
        ...
        <script type="text/javascript">
            ...
            function selesaiPengajuan(data) {
                ...
                window.location.href = "<?=base_url().'Petugas/inputHasilPengujian/dataTera/' ?>"+id;
            }
        ...
        <script type="text/javascript">
            ...
            function prosesPengajuan(id) {
                swal({
                    ...
                    window.location.href = "<?=base_url().'Petugas/prosesPengajuan/' ?>"+id;
                });
            }
        </script>
