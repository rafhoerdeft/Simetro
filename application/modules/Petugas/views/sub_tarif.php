            ...
            <div class="row page-titles">
                ...
                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url().'Petugas/dataTarif' ?>" class="text-danger">Tarif Retribusi</a></li>
                        <?php 
                        ...
                        <?php } else { ?>
                            <li class="breadcrumb-item"><a href="<?= base_url().'Petugas/subTarif/'.encode($subTarif[$i]->id_sub) ?>" class="text-danger"><?= $subTarif[$i]->sub ?></a></li>
                        <?php }} ?>
                    </ol>
                </div>
            ...
            <div id="modal-simpan" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="simpanTarif" method="POST" action="<?= base_url().'Petugas/simpanSubTarif/'.encode($subTarif[0]->id_sub) ?>">
            ...
            <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateTarif" method="POST" action="<?= base_url().'Petugas/updateSubTarif/'.encode($subTarif[0]->id_sub) ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function showConfirmMessage(id, no) {
                swal({
                    ...
                    window.location.href = "<?= base_url('Petugas/deleteSubTarif/').encode($subTarif[0]->id_sub).'/'?>"+id+'/'+no;
                    // $.ajax({
                    //     type : "GET",
                    //     url  : "<?php //echo base_url('Petugas/deleteSubTarif/').encode($subTarif[0]->id_sub).'/'?>"+id+'/'+no,
                    //     dataType : "html",
                    //     // data : {id:id, no:no},
