                                            ...
                                            <tr>
                                                ...
                                                <td width="100">
                                                    ...
                                                    <div class="d-none d-sm-none d-md-block d-lg-block">
                                                        <a href="<?= base_url().'Petugas/subTarif/'.encode($tarif->id_tarif) ?>" class="btn btn-sm btn-warning m-b-5" style="width: 40px;" title="Sub Tarif"><i class="fa fa-eye"></i></a>
                                                        ...
                                                        <button type="button" onclick="showConfirmMessage('<?= $tarif->id_tarif ?>')" class="btn btn-sm waves-effect waves-light btn-danger m-b-5" style="width: 40px" title="Hapus Data"><i class="fa fa-trash-o"></i></button>
                                                    </div>
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="<?= base_url().'Petugas/subTarif/'.encode($tarif->id_tarif) ?>"><i class="fa fa-eye"></i> Sub Tarif</a>
            ...
            <div id="modal-simpan" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="simpanTarif" method="POST" action="<?= base_url().'Petugas/simpanTarif' ?>">
            ...
            <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateTarif" method="POST" action="<?= base_url().'Petugas/updateTarif' ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    window.location.href = "<?= base_url('Petugas/deleteTarif/') ?>"+id;
                    // $.ajax({
                    //     type : "POST",
                    //     url  : "<?php //echo base_url('Petugas/deleteTarif')?>",
                    //     dataType : "html",
                    //     data : {id:id},
