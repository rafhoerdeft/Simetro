            ...
            <div id="modal-tambah" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="inputDataPasar" method="POST" action="<?= base_url().'Petugas/inputDataPasar' ?>">
            ...
            <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateDataPasar" method="POST" action="<?= base_url().'Petugas/updateDataPasar' ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            ...
            function editData(data) {
                ...
                $.post("<?= base_url().'Petugas/getDataPasar' ?>", {kode_desa:kode_desa}, function(result){
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo base_url('Petugas/deleteDataPasar')?>",
                        dataType : "html",
                        data : {id:id},
