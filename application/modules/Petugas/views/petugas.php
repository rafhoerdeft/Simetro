        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-6 align-self-center">
                    <h3 class="text-themecolor">Data Petugas</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body p-b-20">
                        <button type="button" onclick="showModalAdd()" class="btn waves-effect waves-light btn-primary float-right"><i class="fa fa-plus"></i> Tambah Petugas</button>
                        <br><br>
                        <hr>
                            ...
                            <table id="myTable" class="table-bordered table-striped table-hover" cellpadding="7px" width="100%">
                                <thead align="center" class="bg-megna text-white">
                                    <tr style="font-size: 10pt">
                                        <th width="5%"><b>#</b></th>
                                        <th width="17%"><b>Nama Petugas</b></th>
                                        <th width="10%"><b>Jenis Kelamin</b></th>
                                        <th width="11%"><b>Jabatan</b></th>
                                        <th width="10%"><b>NIP</b></th>
                                        <th width="10%"><b>Username</b></th>
                                        <th width="10%"><b>No. HP</b></th>
                                            ...
                                            <tr style="font-size: 10pt">
                                                ...
                                                <td align="center">
                                                    ...
                                                    <div class="d-none d-sm-none d-md-block d-lg-block">
                                                        ...
                                                        <!-- <a href="<?//= base_url().'Petugas/dataUsaha/'.encode($usr->id_user) ?>" style="width: 35px" class="btn btn-sm waves-effect waves-light btn-inverse m-b-5" title="Tambah Usaha"><i class="fa fa-plus"></i></a> -->
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <!-- <a class="dropdown-item" href="<?//= base_url().'Petugas/dataUsaha/'.encode($usr->id_user) ?>"><i class="fa fa-plus"></i> Tambah Usaha</a> -->
            ...
            <div id="modal-simpan" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="tambahDataPetugas" method="POST" action="<?= base_url().'Petugas/tambahDataPetugas' ?>">
                            <div class="modal-body">

                                <input type="hidden" name="id_role" id="id_role" value="<?= $id_role ?>">

                                <div class="form-group">
                                    <label for="nama_user" class="control-label">Nama Petugas :</label>
                                    <div class="controls">
            ...
            <div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateDataPetugas" method="POST" action="<?= base_url().'Petugas/updateDataPetugas' ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    window.location.href = "<?=base_url().'Petugas/deleteDataPetugas/' ?>"+id;
                });
            }
        </script>
