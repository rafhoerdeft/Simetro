            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body p-b-20">
                        <form id="simpanAkun" method="POST" action="<?= base_url().'Petugas/simpanAkun' ?>">
                            <div class="modal-body">

                                <div class="form-group">
                                    <label for="username" class="control-label">Username :</label>
                                    <div class="controls">
                                        <input required type="text" class="form-control" name="username" id="username" placeholder="Isi username untuk login" value="<?= $dataUser->username ?>">
                                    </div>
                                </div>
