<?php 
 ...
 //        )
  ...
  //       )
	...
	$excel->setActiveSheetIndex(0)->getStyle('B4')->getAlignment()->setWrapText(true);

	$excel->getActiveSheet()->mergeCells('C4:D4');
	$excel->setActiveSheetIndex(0)->setCellValue('C4', "RINCIAN SETORAN");
	$excel->setActiveSheetIndex(0)->getStyle('C4:D4')->getAlignment()->setWrapText(true);

	$excel->setActiveSheetIndex(0)->setCellValue('E4', "JUMLAH (Rp)");
	$excel->setActiveSheetIndex(0)->getStyle('E4')->getAlignment()->setWrapText(true);

	$excel->setActiveSheetIndex(0)->setCellValue('F4', "SUB TOTAL (Rp)");
	$excel->setActiveSheetIndex(0)->getStyle('F4')->getAlignment()->setWrapText(true);
	...
	foreach ($dataSetor as $setor) { 
		...
		$excel->getActiveSheet()->getStyle('F'.$row)->applyFromArray($style_body6);
        ...
        foreach ($dataOrder as $order) {
            if ($order->tgl_bayar == $setor->tgl_bayar) {
            	...
            	$excel->getActiveSheet()->mergeCells('C'.$row_rincian.':D'.$row_rincian);
                $excel->setActiveSheetIndex(0)->setCellValue('C'.$row_rincian, 'adsaf af a adsdfadfa daf a faddf  sadsf afsd daf ad ads adf a adf dfadfa ad ad ad df adf ad addfda');
                $excel->getActiveSheet()->getStyle('C'.$row_rincian.':D'.$row_rincian)->getAlignment()->setWrapText(true);
            	$excel->getActiveSheet()->getStyle('C'.$row_rincian.':D'.$row_rincian)->applyFromArray($style_body4);
                ...
                foreach ($dataBayar as $byr) {
                    if ($byr['id_daftar'] == $order->id_daftar) {
                    	...
                    	$excel->setActiveSheetIndex(0)->setCellValueExplicit('E'.$row_rincian, nominal($byr['tarif']*$byr['jml_uttp']), PHPExcel_Cell_DataType::TYPE_STRING);
						...
						$excel->getActiveSheet()->getStyle('F'.$row_rincian)->applyFromArray($style_body6);
                    }
                }

	    		$excel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$row_rincian, nominal($tot_tarif), PHPExcel_Cell_DataType::TYPE_STRING);
				...
				$excel->getActiveSheet()->getStyle('C'.$row_rincian.':D'.$row_rincian)->applyFromArray($style_body3);
				$excel->getActiveSheet()->getStyle('E'.$row_rincian)->applyFromArray($style_body5);
				$excel->getActiveSheet()->getStyle('F'.$row_rincian)->applyFromArray($style_body5);
	...
	$excel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$row, nominal($tot_setor), PHPExcel_Cell_DataType::TYPE_STRING);
	...
	// $newRow3 = $newRow2 + 3;
	// $newRow4 = $newRow3 + 1;
	// $excel->getActiveSheet()->mergeCells('H'.$newRow1.':K'.$newRow1);
	// $excel->setActiveSheetIndex(0)->setCellValue('H'.$newRow1,"Kota Mungkid, ".$tgl_print.' '.$bln_print.' '.$thn_print);
	// $excel->getActiveSheet()->getStyle('H'.$newRow1)->getFont()->setName('Times New Roman');
	// $excel->getActiveSheet()->getStyle('H'.$newRow1)->getFont()->setSize(12);
	// $excel->getActiveSheet()->getStyle('H'.$newRow1)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

	// $excel->getActiveSheet()->mergeCells('H'.$newRow2.':K'.$newRow2);
	// $excel->setActiveSheetIndex(0)->setCellValue('H'.$newRow2,"PENANGGUNG JAWAB TEKNIK");
	// $excel->getActiveSheet()->getStyle('H'.$newRow2)->getFont()->setName('Times New Roman');
	// $excel->getActiveSheet()->getStyle('H'.$newRow2)->getFont()->setSize(12);
	// $excel->getActiveSheet()->getStyle('H'.$newRow2)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);


	// $excel->getActiveSheet()->mergeCells('H'.$newRow3.':K'.$newRow3);
	// $excel->setActiveSheetIndex(0)->setCellValue('H'.$newRow3,"DARMANTO");
	// $excel->getActiveSheet()->getStyle('H'.$newRow3)->getFont()->setName('Times New Roman');
	// $excel->getActiveSheet()->getStyle('H'.$newRow3)->getFont()->setSize(12);
	// $excel->getActiveSheet()->getStyle('H'.$newRow3)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	...
	// // Apply style 
	$excel->getActiveSheet()->getStyle('A1:F1')->applyFromArray($style_title1);
	$excel->getActiveSheet()->getStyle('A2:F2')->applyFromArray($style_title1);

	$excel->getActiveSheet()->getStyle('A4')->applyFromArray($style_header1);
	$excel->getActiveSheet()->getStyle('B4')->applyFromArray($style_header1);
	$excel->getActiveSheet()->getStyle('C4:D4')->applyFromArray($style_header1);
	$excel->getActiveSheet()->getStyle('E4')->applyFromArray($style_header1);
	$excel->getActiveSheet()->getStyle('F4')->applyFromArray($style_header2);
	
	

	// Set width kolom
	$excel->getActiveSheet()->getColumnDimension('A')->setWidth(4.85);
	$excel->getActiveSheet()->getColumnDimension('B')->setWidth(15.50);
	$excel->getActiveSheet()->getColumnDimension('C')->setWidth(35.10);
	...
	$excel->getActiveSheet()->getRowDimension('4')->setRowHeight(36.5);
