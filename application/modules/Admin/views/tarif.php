        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-6 align-self-center">
                    <h3 class="text-themecolor">Tarif Retribusi</h3>
                </div>

                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                        <!-- <label>Jenis Perlengkapan</label> -->
                        <li class="breadcrumb-item active">Tarif Retribusi</li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body p-b-20">
                        <button type="button" onclick="showModalAdd()" class="btn waves-effect waves-light btn-inverse float-right"><i class="fa fa-plus"></i> Tambah Tarif</button>
                        <br><br>
                        <hr>
                        <div class="table-responsive">
                            <table id="myTable" class="table-bordered table-striped table-hover" cellpadding="7px" width="100%">
                                <thead align="center" class="bg-megna text-white" style="font-size: 10pt">
                                    <tr>
                                        <th rowspan="3">#</th>
                                        <th rowspan="3" width="40%">Nama Tarif</th>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td nowrap>
                                                    ...
                                                    <div class="d-none d-sm-none d-md-block d-lg-block" style="width: 115px;">
                                                        <a href="<?= base_url().'Admin/subTarif/'.encode($tarif->id_tarif) ?>" class="btn btn-sm btn-warning m-b-5" style="width: 35px;" title="Sub Tarif"><i class="fa fa-eye"></i></a>
                                                        <button type="button" data-id="<?= $tarif->id_tarif ?>" data-jenis="<?= $tarif->jenis_tarif ?>" data-satuan="<?= $tarif->satuan ?>" data-tera-a="<?= number_format($tarif->tera_kantor,0,'.','.') ?>" data-tera-b="<?= number_format($tarif->tera_tempat_pakai,0,'.','.') ?>" data-tera-ulang-a="<?= number_format($tarif->tera_ulang_kantor,0,'.','.') ?>" data-tera-ulang-b="<?= number_format($tarif->tera_ulang_tempat_pakai,0,'.','.') ?>" onclick="showModalEdit(this)" class="btn btn-sm waves-effect waves-light btn-info m-b-5" style="width: 35px" title="Edit Data"><i class="fa fa-pencil-square-o"></i></button>
                                                        <button type="button" onclick="showConfirmMessage('<?= $tarif->id_tarif ?>')" class="btn btn-sm waves-effect waves-light btn-danger m-b-5" style="width: 35px" title="Hapus Data"><i class="fa fa-trash-o"></i></button>
                                                    </div>
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="javascript:void(0)" onclick="showConfirmMessage('<?= $tarif->id_tarif ?>')"><i class="fa fa-trash-o"></i> Hapus Data</a>
            ...
            <div id="modal-simpan" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="simpanTarif" method="POST" action="<?= base_url().'Admin/simpanTarif' ?>">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input required type="text" onkeyup="changeRupe(this)" onkeypress="return inputAngka(event);" class="form-control" name="tera_kantor" id="tera_kantor" placeholder="Isi nilai tarif retribusi">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input required type="text" onkeyup="changeRupe(this)" onkeypress="return inputAngka(event);" class="form-control" name="tera_tempat_pakai" id="tera_tempat_pakai" placeholder="Isi nilai tarif retribusi">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input required type="text" onkeyup="changeRupe(this)" onkeypress="return inputAngka(event);" class="form-control" name="tera_ulang_kantor" id="tera_ulang_kantor" placeholder="Isi nilai tarif retribusi">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input required type="text" onkeyup="changeRupe(this)" onkeypress="return inputAngka(event);" class="form-control" name="tera_ulang_tempat_pakai" id="tera_ulang_tempat_pakai" placeholder="Isi nilai tarif retribusi">
                                    </div>
                                </div>
                            </div>
            ...
            <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateTarif" method="POST" action="<?= base_url().'Admin/updateTarif' ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function showModalAdd(argument) {
                $('#modal-simpan #simpanTarif').trigger("reset");
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    window.location.href = "<?= base_url('Admin/deleteTarif/') ?>"+id;
                    // $.ajax({
                    //     type : "POST",
                    //     url  : "<?php //echo base_url('Admin/deleteTarif')?>",
                    //     dataType : "html",
                    //     data : {id:id},
