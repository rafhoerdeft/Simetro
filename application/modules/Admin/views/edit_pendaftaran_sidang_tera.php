        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-6 align-self-center">
                    <h3 class="text-themecolor">Ubah Pengajuan Tera/Tera Ulang</h3>
                </div>
                ...
                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Ubah Pengajuan Tera</li>
                    </ol>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body p-b-20">
                        ...
                        <form id="pengajuanTera" method="POST" action="<?= base_url().'Admin/updatePengajuanSidangTera/'.encode($id_sidang) ?>">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr style="height: 40px">
                                                        ...
                                                        <td><?= $list->jenis_alat.' '.$kapasitas ?></td>
        ...
        <script type="text/javascript">
            ...
            function cekTarif(argument) {
                ...
                var tempat = $("#pengajuanTera input[type='hidden'][name='tempat']").attr('data-grup');
