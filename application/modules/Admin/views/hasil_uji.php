                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 m-b-5">
                                ...
                                <select class="form-control" id="select_status" onchange="changeStatus()">
                                    ...
                                    <option value="belum" <?= ($selectStatus == 'belum'?'selected':'') ?>>Belum Bayar</option>

                                    <option value="sudah" <?= ($selectStatus == 'sudah'?'selected':'') ?>>Lunas</option>
                                    ...
                                    ?>
                                            ...
                                            <tr style="font-size: 10pt">
                                                ...
                                                <td width="100">
                                                    ...
                                                    <span style="font-size: 7.2pt; width: 85px; text-align: center; font-weight: bold;" class="label label-<?= ($tera->bayar > 0?($tera->nominal_bayar >= $byr['tot_tarif']?'success':'warning'):'danger') ?>"><?= ($tera->bayar > 0?($tera->nominal_bayar >= $byr['tot_tarif']?'Lunas':'Belum Lunas'):'Belum Bayar') ?></span>

                                                    <?php if ($selectStatus != 'belum') { ?>
                                                        <div class="m-t-5">

                                                            <button type="button" <?= ($tera->bayar==0?'disabled':'') ?> class="btn btn-sm <?= ($tera->bayar==0?'btn-default':'btn-inverse waves-effect waves-light') ?> m-b-5" style="width: 85px" onclick="cetakKwitansi(<?= $tera->id_daftar ?>)"  title="Cetak Kwitansi"><i class="fa fa-credit-card-alt"></i> Kwitansi</button>
                                                ...
                                                <td>
                                                    ...
                                                    <div style="width: 75px">
                                                        ...
                                                        <a href="<?= base_url('Admin/cetakHasilPengujian/'.encode($tera->id_daftar)) ?>" class="btn btn-sm btn-danger waves-effect waves-light m-b-5" style="width: 35px"  title="Cetak Hasil"><i class="fa fa-file-text-o"></i></a>
                                                        ...
                                                        ?>
                                                                ...
                                                                <button <?= $tera->nominal_bayar >= $byr['tot_tarif']?'disabled':'' ?> type="button" data-id="<?= $tera->id_daftar ?>" data-bayar="<?= $byr['tot_tarif'] ?>" class="btn btn-sm <?= $tera->nominal_bayar >= $byr['tot_tarif']?' btn-default':' btn-info waves-effect waves-light' ?> m-b-5" style="width: 35px" onclick="inputBayar(this)"  title="Bayar"><i class="fa fa-money"></i></button>
                                                        ...
                                                        <!-- <button type="button" <?= ($tera->bayar==0 || $tera->status=='selesai'?'disabled':'') ?> class="btn btn-sm <?= ($tera->bayar==0 || $tera->status=='selesai'?'btn-default':'btn-success waves-effect waves-light') ?> m-b-5" onclick="selesaiPengajuan(<?= $tera->id_daftar ?>)" style="width: 35px" title="Selesaikan Pengajuan"><i class="fa fa-check"></i></button> -->
            ...
            <div id="modal-bayar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="inputPembayaran" method="POST" action="<?= base_url().'Admin/inputPembayaran' ?>" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="ket_bayar" class="control-label">Total Bayar: <b id="tot_tarif">Rp. 150.000,-</b></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nominal_bayar" onkeyup="changeRupe(this)" onkeypress="return inputAngka(event);" placeholder="" name="nominal_bayar" required autocomplete="off">
        ...
        <script type="text/javascript">
            ...
            function inputBayar(data) {
                ...
                $('#modal-bayar #inputPembayaran #nominal_bayar').val(formatRupiah(tot_tarif, 'Rp.'));
                ...
                $.post("<?= base_url().'Admin/getDataPembayaran' ?>", {id_daftar:id}, function(result){
            ...
            function cetakKwitansi(id='') {
                ...
                $.post("<?= base_url().'Admin/getDataKwitansi' ?>", {id_daftar:id}, function(result){
                    ...
                    if (dt.response) {
                        ...
                        $('#modal-kwitansi #tanggal_cetak').html(addZero(tgl_cetak.getDate())+' '+nama_bulan(tgl_cetak.getMonth())+' '+tgl_cetak.getFullYear());
        ...
        <script type="text/javascript">
            ...
            function printForm(argument) {
                    ...
                    // window.location.href = "<?//=base_url().'Admin/hasilPengujian' ?>";
        ...
        <script type="text/javascript">
            ...
            function changeStatus() {
                ...
                window.location.href = "<?=base_url().'Admin/hasilPengujian/' ?>"+status;

            }



            function selesaiPengajuan(id_daftar) {

                swal({

                    title: "Selesaikan Pengajuan?",

                    text: "Selesaikan pengajuan tera ini?",
                    ...
                    window.location.href = "<?=base_url().'Admin/selesaiPengajuan/' ?>"+id_daftar;
        ...
        <script type="text/javascript">
            ...
            //         window.location.href = "<?=base_url().'Admin/proseshasilPengujian/' ?>"+id;
