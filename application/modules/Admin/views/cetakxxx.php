<?php 
 ...
 //        )
  ...
  //       )
	...
	$excel->getActiveSheet()->getColumnDimension('B')->setWidth(16.50);
	$excel->getActiveSheet()->getColumnDimension('C')->setWidth(48.10);
	$excel->getActiveSheet()->getColumnDimension('D')->setWidth(17.5);
	$excel->getActiveSheet()->getColumnDimension('E')->setWidth(17.5);
	...
	foreach ($dataSetor as $setor) { 
        ...
        foreach ($dataOrder as $order) {
            if ($order->tgl_bayar == $setor->tgl_bayar) {
                ...
                $excel->setActiveSheetIndex(0)->setCellValue('C'.$row_rincian, $order->nama_user.' / '.$order->nama_usaha);
	...
	$excel->setActiveSheetIndex(0)->setCellValue('D'.$newRow5,"Drs. ASFURI, M.Si.");
	...
	$excel->setActiveSheetIndex(0)->setCellValue('D'.$newRow6,"Pembina Utama Muda");
	...
	$excel->setActiveSheetIndex(0)->setCellValue('D'.$newRow7,"NIP. 19670305 199303 1 007");
