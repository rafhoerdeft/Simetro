            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-b-20">
                        ...
                        <form id="pengajuanSidangTera" method="POST" action="<?= base_url().'Admin/pengajuanSidangTera' ?>">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="no_order" id="no_order" value="<?= $no_order.'-'.$id_user ?>">
        ...
        <script type="text/javascript">
            ...
            function addUttp(argument) {
                ...
                var id_usaha = $('#pengajuanSidangTera #id_usaha').val();
                    ...
                    if (id_uttp_first != null) {
                        ...
                        $.post("<?= base_url().'Admin/getDataUttp' ?>", {select_id_uttp:select_id_uttp, id_usaha:id_usaha}, function(result){
                            ...
                            if (dt.response) {
                                ...
                                $('#pengajuanSidangTera .modal-body #data_uttp').append(groupUttp);
                                ...
                                //     $('#pengajuanSidangTera .modal-body #data_uttp #uttp-'+nextCount).prepend(exit);
        ...
        <script type="text/javascript">
            ...
            function changeDataUser(data) {
                ...
                var cek = $('#pengajuanSidangTera #cek').val();
