      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <h4 class="card-judul">
              Data berita
              <a href="<?=base_url();?>Admin/add_berita" class="btn btn-primary fa fa-plus-circle float-right"></a>
            </h4>
                ...
                <tbody>
                  <?php $no = 1; foreach($beritas->result() as $berita) { ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?=base_url('Admin/edit_berita/'.$berita->id_berita);?>" class="btn btn-sm btn-warning fa fa-edit"></a>
                        <a href="<?=base_url();?>Admin/delete_berita/<?=$berita->id_berita;?>/<?=$berita->image;?>" class="btn btn-sm btn-danger fa fa-trash" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
