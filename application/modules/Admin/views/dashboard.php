            ...
            <div class="container-fluid">
                ...
                <div class="card-group">
                    ...
                    <div class="card card-inverse card-warning m-1">
                        <a href="<?= base_url().'Admin/dataPetugas' ?>">
                            <div class="card-body">
                                <div class="d-flex" style="margin-top: -10px; margin-bottom: -20px">
                                    <div class="m-r-20 align-self-center">
                ...
                <div class="card-group">
                    ...
                    <div class="card">
                        <!-- <a href="<?= base_url().'Admin/dataTera/belumkirim' ?>"> -->
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                    ...
                    <!-- Column -->
                    <div class="card">
                        <!-- <a href="<?= base_url().'Admin/dataTera/diterima' ?>"> -->
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                    ...
                    <!-- Column -->
                    <div class="card">
                        <!-- <a href="<?= base_url().'Admin/dataTera/proses' ?>"> -->
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                    ...
                    <!-- Column -->
                    <div class="card">
                        <!-- <a href="<?= base_url().'Admin/dataTera/selesai' ?>"> -->
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
