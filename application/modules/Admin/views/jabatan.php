        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-6 align-self-center">
                    <h3 class="text-themecolor">Jenis Jabatan</h3>
                </div>
                                            ...
                                            <tr style="font-size: 12pt">
                                                ...
                                                <td width="130" align="center">
                                                    <div class="d-none d-sm-none d-md-block d-lg-block">
                                                        <button type="button" data-id="<?= $jb->id_jabatan ?>" data-nama="<?= $jb->nama_jabatan ?>" onclick="editData(this)" class="btn btn-sm btn-info waves-effect waves-light m-b-5" style="width: 35px" title="Edit Jabatan"><i class="fa fa-edit"></i></button>

                                                        <button type="button" class="btn btn-sm btn-danger waves-effect waves-light m-b-5" style="width: 35px" onclick="showConfirmMessage(<?= $jb->id_jabatan ?>)" title="Hapus Jabatan"><i class="fa fa-trash"></i></button>
                                                    </div>
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="javascript:void(0)" data-id="<?= $jb->id_jabatan ?>" data-nama="<?= $jb->nama_jabatan ?>" onclick="editData(this)"><i class="fa fa-pencil-square-o"></i> Edit Jabatan</a>
                                                            <a class="dropdown-item" href="javascript:void(0)" onclick="showConfirmMessage('<?= $jb->id_jabatan ?>')"><i class="fa fa-trash-o"></i> Hapus Jabatan</a>
            ...
            <div id="modal-tambah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="tambahDataJabatan" method="POST" action="<?= base_url().'Admin/tambahDataJabatan' ?>">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_jabatan" placeholder="Masukkan nama Jabatan" name="nama_jabatan" required autocomplete="off">
                                </div>
            ...
            <div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateDataJabatan" method="POST" action="<?= base_url().'Admin/updateDataJabatan' ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function tambahData() {
                $('#modal-tambah #tambahDataJabatan').trigger("reset");
            ...
            function editData(data) {
                ...
                $('#modal-edit #id_jabatan').val(id);
                $('#modal-edit #nama_jabatan').val(nama);
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo base_url('Admin/deleteDataJabatan')?>",
                        dataType : "html",
                        data : {id:id},
