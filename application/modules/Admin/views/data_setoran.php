        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <h3 class="text-themecolor">Laporan Setoran</h3>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="margin-bottom: -5px" id="paramLap">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 m-b-5">
                                ...
                                <select class="form-control" id="select_thn">
                                    ...
                                    <?php if ($tahun != null) { ?>
                                        ...
                                        <?php } ?>
                                    <?php } else { ?>
                                        <option value="<?=encode(date('Y'));?>" <?= ($selectTahun==date('Y')?'selected':'') ?>><?=date('Y')?></option>
                                    <?php } ?>
                            ...
                            <input type="hidden" name="select_pasar" id="select_pasar" value="">
                                            ...
                                            <tr style="font-size: 10pt">
                                                ...
                                                <td>
                                                    ...
                                                    foreach ($dataOrder as $order) {
                                                        ...
                                                        if ($order->tgl_bayar == $setor->tgl_bayar) {
                                                            ...
                                                            echo '<div>'.$order->nama_user.($order->nama_usaha!=null && $order->nama_usaha!=''?' / '.$order->nama_usaha:'').'</div>';
                                                ...
                                                <td width="100" align="center">
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <button style="font-size: 10pt" type="button" class="btn btn-sm btn-primary waves-effect waves-light m-b-5" onclick="cetakSetoran('<?= $setor->tgl_bayar ?>')" title="Cetak Setoran"><i class="fa fa-print"></i></button>
        ...
        <script type="text/javascript">
            ...
            function tampilData(argument) {
                ...
                window.location.href = "<?=base_url().'Admin/lapSetoran/' ?>"+bln+'/'+thn+'/'+pasar;
            ...
            function cetakLaporan(argument) {
                ...
                window.location.href = "<?=base_url().'Admin/cetakLapSetoran/' ?>"+bln+'/'+thn+'/'+pasar;
        ...
        <script type="text/javascript">
            ...
            function printForm(argument) {
                    ...
                    window.location.href = "<?=base_url().'Admin/lapSetoran' ?>";
