            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-b-20">
                        ...
                        <form id="pengajuanTera" method="POST" action="<?= base_url().'Admin/pengajuanTera' ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="tgl_daftar" required id="tgl_daftar" class="datepicker form-control" value="<?= date('d-m-Y') ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
