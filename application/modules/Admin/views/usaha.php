                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr style="font-size: 11pt">
                                                ...
                                                <td><?= $usaha->alamat ?></td>
                                                <td>
                                                    <div class="d-none d-sm-none d-md-block d-lg-block" style="width: 113px">
                                                        <button type="button" data-id="<?= $usaha->id_usaha ?>" onclick="showModalEdit(<?= $usaha->id_usaha ?>)" class="btn btn-sm waves-effect waves-light btn-info" style="width: 35px; margin-bottom: 5px" title="Edit Data"><i class="fa fa-pencil-square-o"></i></button>

                                                        <a href="<?= base_url().'Admin/dataUttp/'.encode($usaha->id_usaha).'/'.encode($idUser).'/'.encode($uri) ?>" style="width: 35px; margin-bottom: 5px" class="btn btn-sm waves-effect waves-light btn-inverse m-b-5" title="Tambah UTTP"><i class="fa fa-plus"></i></a>

                                                        <button type="button" onclick="showConfirmMessage('<?= $usaha->id_usaha ?>')" class="btn btn-sm waves-effect waves-light btn-danger" style="width: 35px; margin-bottom: 5px" title="Hapus Data"><i class="fa fa-trash-o"></i></button>
                                                    </div>
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="javascript:void(0)" onclick="showModalEdit(<?= $usaha->id_usaha ?>)"><i class="fa fa-pencil-square-o"></i> Edit Data Usaha</a>

                                                            <a class="dropdown-item" href="<?= base_url().'Admin/dataUttp/'.encode($usaha->id_usaha).'/'.encode($idUser).'/'.encode($uri) ?>"><i class="fa fa-plus"></i> Tambah UTTP</a>

                                                            <a class="dropdown-item" href="javascript:void(0)" onclick="showConfirmMessage('<?= $usaha->id_usaha ?>')"><i class="fa fa-trash-o"></i> Hapus Data Usaha</a>
            ...
            <div id="modal-simpan" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="tambahDataUsaha" method="POST" action="<?= base_url().'Admin/simpanUsaha/'.$uri ?>">
            ...
            <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateDataUsaha" method="POST" action="<?= base_url().'Admin/updateUsaha/'.$uri ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            ...
            function showModalEdit(id) {
                ...
                $.post("<?= base_url().'Admin/getDataEditUsaha' ?>", {id:id}, function(result){
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo base_url('Admin/deleteUsaha')?>",
                        dataType : "html",
                        data : {id:id},
