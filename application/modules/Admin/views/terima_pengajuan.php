            ...
            <div class="row page-titles">
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url().'Admin/pengajuanMasuk' ?>" class="text-danger">Pengajuan Masuk</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-b-20">
                        ...
                        <!-- <form method="POST" action="<?//= base_url().'Admin/terimaPengajuanMasuk' ?>"> -->
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php $colors = array('orange','blue','red','green','black'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="text-danger"><b><?= $dataUser->nama_user.($dataUser->alamat_user!=null || $dataUser->alamat_user != ''?' - '.$dataUser->alamat_user:'') ?></b></label>
                            ...
                            <div class="row p-20 float-right d-block d-sm-block d-md-none d-lg-none">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="<?= base_url('Admin/pengajuanMasuk') ?>" class="btn btn-danger waves-effect m-r-5"><i class="fa fa-arrow-left"></i></a>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 m-b-5" style="text-align: right;">
                                            ...
                                            <a href="<?= base_url('Admin/pengajuanMasuk') ?>" class="btn btn-danger waves-effect waves-light btn-block d-none d-sm-none d-md-block d-lg-block"><i class="fa fa-arrow-left"></i> Kembali</a>
            ...
            <div id="modal-set" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="setTarifUttp" method="POST" action="<?= base_url().'Admin/setTarifUttp' ?>">
            ...
            function terimaPengajuan(id='', count='', count_all='', data) {
                ...
                if (count == count_all) {
                    ...
                    swal({
                        ...
                        window.location.href = "<?=base_url().'Admin/terimaPengajuanMasuk/' ?>"+id+'/'+id_tarif+'/'+id_list;
