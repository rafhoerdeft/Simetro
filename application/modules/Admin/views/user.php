                                            ...
                                            <tr style="font-size: 11pt">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-none d-sm-none d-md-block d-lg-block" style="width: 115px">
                                                        ...
                                                        <a href="<?= base_url().'Admin/dataUsaha/'.encode($usr->id_user).'/'.encode($this->uri->segment(3)) ?>" style="width: 35px" class="btn btn-sm waves-effect waves-light btn-inverse m-b-5" title="Tambah Usaha"><i class="fa fa-plus"></i></a>
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="<?= base_url().'Admin/dataUsaha/'.encode($usr->id_user).'/'.encode($this->uri->segment(3)) ?>"><i class="fa fa-plus"></i> Tambah Usaha</a>
            ...
            <div id="modal-simpan" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="tambahDataUser" method="POST" action="<?= base_url().'Admin/tambahDataUser' ?>">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text"  onkeypress="return inputAngka(event);" class="form-control" name="no_hp" id="no_hp" autocomplete="off">
                                    </div>
                                </div>
            ...
            <div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateDataUser" method="POST" action="<?= base_url().'Admin/updateDataUser/'.$this->uri->segment(3) ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    window.location.href = "<?=base_url().'Admin/deleteDataUser/' ?>"+id;
                });
            }
        </script>
