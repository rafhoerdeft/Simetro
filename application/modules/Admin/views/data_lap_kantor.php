        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-6 align-self-center">
                    <h3 class="text-themecolor">Data Tera Ulang Kantor</h3>
                </div>

                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                        <!-- <label>Jenis Perlengkapan</label> -->
                        <li class="breadcrumb-item active">Data Tera Ulang Kantor</li>
                    </ol>
                </div>
                            ...
                            <table id="myTable" class="table-bordered table-striped table-hover" cellpadding="7px" width="100%">
                                <thead align="center" class="bg-megna text-white" style="font-size: 9pt">
                                    <tr>
                                        ...
                                        <th rowspan="2"><b>Pemilik UTTP</b></th>
                                    ...
                                    <tr>
                                        ...
                                        <th width="40"><b>TP</b></th>
                                        <th width="40"><b>TBI</b></th>
                                        <th width="40"><b>TE</b></th>
                                        <th width="40"><b>DL</b></th>
                                        <th width="40"><b>N</b></th>
                                        <th width="40"><b>UP</b></th>
                                        <th width="40"><b>ATH</b></th>
                                        <th width="40"><b>ATB</b></th>
                                        <th width="40"><b>TAK</b></th>
                                        <th width="40"><b>Kwh</b></th>
                                        <th width="40"><b>MT</b></th>
                                        <th width="40"><b>Bj</b></th>
                                        <th width="40"><b>TC</b></th>
                                        <th width="40"><b>GU</b></th>
                                        <th width="40"><b>MKA</b></th>
                                        <th width="40"><b>Tensi</b></th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <script type="text/javascript">
            function tampilData(argument) {
                ...
                window.location.href = "<?=base_url().'Admin/lapTeraUlangKantor/' ?>"+awal+'/'+akhir;
            }
            ...
            function cetakLaporan(argument) {
                ...
                window.location.href = "<?=base_url().'Admin/cetakLapKantor/' ?>"+awal+'/'+akhir;
            }
