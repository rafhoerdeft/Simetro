            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body p-b-20">
                        <button type="button" onclick="showModalAdd()" class="btn waves-effect waves-light btn-primary float-right"><i class="fa fa-plus"></i> Tambah Pegawai</button>
                        <br><br>
                        <hr>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr style="font-size: 10pt">
                                                ...
                                                <td><?= $usr->nama_user ?></td>
                                                <td align="center"><?= $usr->jk_user ?></td>
                                                <td align="center"><?= $usr->jabatan ?></td>
                                                <td align="center"><?= $usr->golongan ?></td>
                                                <td><?= $usr->nip ?></td>
                                                <td><?= $usr->username ?></td>
                                                <td align="center"><?= $usr->no_hp ?></td>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <div class="d-none d-sm-none d-md-block d-lg-block" style="width: 75px;">
                                                        <button style="width: 35px" type="button" 
                                                            ...
                                                            data-jk="<?= $usr->jk_user ?>" 
                                                            data-jabatan="<?= $usr->id_jabatan ?>" 
                                                            data-golongan="<?= $usr->golongan ?>" 
                                                            data-nip="<?= $usr->nip ?>" 
                                                        ...
                                                        <!-- <a href="<?//= base_url().'Admin/dataUsaha/'.encode($usr->id_user) ?>" style="width: 35px" class="btn btn-sm waves-effect waves-light btn-inverse m-b-5" title="Tambah Usaha"><i class="fa fa-plus"></i></a> -->
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="javascript:void(0)" 
                                                                ...
                                                                data-noHp="<?= $usr->no_hp ?>" 
                                                                data-almt="<?= $usr->alamat_user ?>" 
                                                                onclick="showModalEdit(this)"><i class="fa fa-pencil-square-o"></i> Edit Data Pegawai</a>
                                                            <!-- <a class="dropdown-item" href="<?//= base_url().'Admin/dataUsaha/'.encode($usr->id_user) ?>"><i class="fa fa-plus"></i> Tambah Usaha</a> -->
                                                            <a class="dropdown-item" href="javascript:void(0)" onclick="showConfirmMessage('<?= $usr->id_user ?>')"><i class="fa fa-trash-o"></i> Hapus Data Pegawai</a>
            ...
            <div id="modal-simpan" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="tambahDataPetugas" method="POST" action="<?= base_url().'Admin/tambahDataPetugas' ?>">
                            <div class="modal-body">

                                <input type="hidden" name="id_role" id="id_role" value="<?= $id_role ?>">

                                <div class="form-group">
                                    <label for="nama_user" class="control-label">Nama Pegawai :</label>
                                    <div class="controls">
                                        <input required type="text" class="form-control" name="nama_user" id="nama_user" placeholder="Isi nama petugas" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="golongan" class="control-label">Pangkat :</label>
                                    <div class="controls">
                                        <input type="text" class="form-control" name="golongan" id="golongan" placeholder="Isi Pangkat Pegawai" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input required type="text" class="form-control" name="nip" id="nip" placeholder="Isi Nomor Identitas Pegawai" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="alamat_user" id="alamat_user" autocomplete="off"></textarea>
                                </div>
                            </div>
            ...
            <div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="updateDataPetugas" method="POST" action="<?= base_url().'Admin/updateDataPetugas' ?>">
                            <div class="modal-body">
        ...
        <script type="text/javascript">
            function showModalAdd(argument) {
                $('#modal-simpan #tambahDataPetugas').trigger("reset");
        ...
        <script type="text/javascript">
            ...
            function showModalEdit(data) {
                ...
                var jabatan = $(data).attr('data-jabatan');
                var golongan = $(data).attr('data-golongan');
                var nip = $(data).attr('data-nip');
                ...
                $('#modal-edit #jabatan').val(jabatan).change();
                $('#modal-edit #golongan').val(golongan);
        ...
        <script type="text/javascript">
            function showConfirmMessage(id) {
                swal({
                    ...
                    window.location.href = "<?=base_url().'Admin/deleteDataPetugas/' ?>"+id;
                });
            }
        </script>
