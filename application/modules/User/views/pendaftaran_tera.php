                            ...
                            <div class="modal-body">
                                ...
                                <div id="data_uttp">
                                    ...
                                    <!-- <div id="uttp-1">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <select required id="id_uttp" name="id_uttp[]" class="form-control" onchange="changeUttp(this)">
                                                    ...
                                                    <?php foreach ($dataUttp as $uttp) { ?>
                                                        <option data="<?= $uttp->id_jenis_alat ?>" value="<?= $uttp->id_uttp ?>"><?= $uttp->jenis_alat ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" id="retribusi-1">
                                                
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-12" id="retribusi-2">
                                                
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-12" id="retribusi-3">
                                                
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-12" id="retribusi-4">
                                                
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-12" id="listTarif">
                                    ...
                                    <table id="tbl_tarif" border="1" width="100%" style="border-color: white; font-size: 10pt" cellpadding="5px">
                                        ...
                                        <tbody>
                                            <tr style="height: 40px">
                                                ...
                                                <td>Kapasitas sampai dengan 25 kg</td>
                                                <td align="center">Buah</td>
                                                <td align="center">Tera Ulang</td>
                                                <td align="center">Tempat Pakai</td>
                                        ...
                                        <tfoot>
                                            <tr class="bg-megna text-white" style="border-color: white; height: 40px">
                                                <td align="center" colspan="7" style="font-weight: bold">Total</td>
                                                <td align="right"  style="font-weight: bold">2.000.000</td>
                                            </tr>
                                        </tfoot>
                                    </table> -->
                                </div>
                        ...
                        $.post("<?= base_url().'User/getDataUttp' ?>", {select_id_uttp:select_id_uttp, id_usaha:id_usaha}, function(result){
                            ...
                            if (dt.response) {
                                ...
                                for (var i = 0; i < dt.data.length; i++) {
                                    ...
                                    opt += '<option data="'+dt.data[i].id_jenis_alat+'" value="'+dt.data[i].id_uttp+'">'+dt.data[i].jenis_alat+' '+kapasitas+'</option>';
                                }
