        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <h3 class="text-themecolor">Data Usaha</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <button type="button" onclick="showModalAdd()" class="btn waves-effect waves-light btn-block btn-primary float-right"><i class="fa fa-plus"></i> Tambah Usaha</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="modal-simpan" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="tambahDataUsaha" method="POST" action="<?= base_url().'User/simpanUsaha' ?>">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-info waves-effect waves-light" id="simpan_usaha"><i class="fa fa-save"></i> Save</button>
            ...
            <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true" style="display: none;">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="updateDataUsaha" method="POST" action="<?= base_url().'User/updateUsaha' ?>">
        ...
        <script type="text/javascript">
            ...
            function getDataDesa(data) {
                ...
                $.post("<?= base_url().'User/getDataDesa' ?>", {kode_kecamatan:kode}, function(result){
        ...
        <script type="text/javascript">
            ...
            function showModalEdit(id) {
                ...
                $.post("<?= base_url().'User/getDataEditUsaha' ?>", {id:id}, function(result){
            ...
            function showConfirmMessage(id) {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        url  : "<?php echo base_url('User/deleteUsaha')?>",
