                    ...
                    <div class="card-body p-b-20">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 m-b-5">
                                ...
                                <select id="usaha" class="form-control" onchange="changeUsaha();">

                                    <?php  if ($dataUsaha == null || $dataUsaha == '') {  ?>

                                            <option disabled="" selected="">Data usaha Anda kosong</option>

                                    <?php } else {

                                            foreach ($dataUsaha as $usaha) { ?>

                                                <option value="<?= encode($usaha->id_usaha) ?>" <?= ($usaha->id_usaha==$selectUsaha?'selected':'') ?> ><?= $usaha->jenis_usaha ?><?= ($usaha->nama_usaha!='' || $usaha->nama_usaha!=null?' - '.$usaha->nama_usaha:'') ?></option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <button type="button" onclick="<?= ($selectUsaha != null?'showModalAdd()':'showAlert()') ?>" class="btn waves-effect waves-light btn-primary btn-block"  title="Edit Data"><i class="fa fa-plus"></i> Tambah UTTP</button>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <div class="d-block d-sm-block d-md-none d-lg-none">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="javascript:void(0)" data-id="<?= $uttp->id_uttp ?>" data-buatan="<?= $uttp->buatan ?>" data-jenis-alat="<?= $uttp->id_jenis_alat ?>" data-no-seri="<?= $uttp->nomor_seri ?>" data-merk="<?= $uttp->merk ?>" data-model="<?= $uttp->model_tipe ?>" data-jml-uttp="<?= $uttp->jml_uttp ?>" data-kapasitas="<?= $uttp->kapasitas ?>" data-thn="<?= $uttp->tahun_pembelian ?>" onclick="showModalEdit(this)"><i class="fa fa-pencil-square-o"></i> Edit Data UTTP</a>



                                                            <a class="dropdown-item" href="javascript:void(0)" onclick="showConfirmMessage('<?= $uttp->id_uttp ?>')"><i class="fa fa-trash-o"></i> Hapus Data UTTP</a>
            ...
            <div id="modal-simpan" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="tambahDataUttp" method="POST" action="<?= base_url().'User/simpanUttp' ?>">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-info waves-effect waves-light" id="simpan_jalan"><i class="fa fa-save"></i> Save</button>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Update Data UTTP</h4>

                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>

                        </div>

                        <form id="updateDataUttp" method="POST" action="<?= base_url().'User/updateUttp' ?>">
        ...
        <script type="text/javascript">
            ...
            function changeUsaha(argument) {
               ...
               window.location = "<?= base_url().'User/dataUttp/' ?>" + id_usaha;
        ...
        <script type="text/javascript">
            ...
            function showAlert(argument) {
                alert('Data usaha Anda kosong. Silahkan tambahkan dahulu data usaha Anda!');
            }
            ...
            function showConfirmMessage(id) {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        url  : "<?php echo base_url('User/deleteUttp')?>",
