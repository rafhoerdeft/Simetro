        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="table-responsive m-t-40">
              <form action="<?=base_url();?>Back_home/save_add_berita" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tanggal" class="form-control" placeholder="<?=date('Y-m-d');?>" value="<?=date('Y-m-d');?>" id="mdate" required>
                </div>
                <div class="form-group">
